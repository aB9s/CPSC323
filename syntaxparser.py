...
def RAT18S():
    ...
    output_file = open(filename + "_syntax_output" + ".txt", "w")
    ...
    while i < (len(lexer_table) - 1):
        ...
        if (i < len(lexer_table) - 1):
            ...
            if (lexeme == "%%"):
                ...
                print ("Token: " + token + " --- Lexeme: " + lexeme)
                output_file.write("Token: " + token + " --- Lexeme: " + lexeme + '\n')
                syntactic_correct, i = OptDeclarationList(lexer_table, i, lexeme, token, output_file)
                syntactic_correct, i = StatementList(lexer_table, i, lexeme, token, output_file)
            else:
                print ("[Line Number:" + line_number + "]=" + "Syntax Error: Missing %% at the end of <Opt Function Definitions>\n")
                output_file.write("Syntax Error: Missing %% at the end of <Opt Function Definitions>]\n")
                output_file.write("Line Number: " + line_number)
                print("Program terminated")
                terminate()


        else:
            print("The End. Program Terminated.")
            terminate()
# End of R1
# End of RAT18S
